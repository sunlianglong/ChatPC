...
namespace QQ_presentation
{
    class Update
    {
        ...
        public static void user_friend_update(string ip_address, string friend_ip,string group_name,string beizhu_data)
        {
            int judge;
            //url
            string url = "http://123.206.17.117/chatting/update_user_friend_group.php";
            ...
            string beizhu = beizhu_data;
            string postData = "search=" + search + "&" + "friend=" + friend+"&"+"group="+group+"&" + "beizhu=" + beizhu;
